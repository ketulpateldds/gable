            ...
            <Transition enter-active-class="transition-all duration-300 ease-out transform"
                ...
                <div v-if="isOpen"
                    ...
                    <div
                        ...
                        <!-- header -->
                        <div class="mb-[25px]">
                            <h2 class="text-[18px] sm:text-[20px] font-bold text-neutral-primary leading-[100%] mb-[3px]">Add Service
                                Pro</h2>
                            <p class="text-[12px] font-medium text-neutral-primary/60 leading-4 tracking-[-2%]">Enter
                                the general information, address, and documents for the service professional.</p>
                        </div>

                        <!-- general information -->
                        <div class="mb-[29px]">
                            <h2 class="text-[14px] sm:text-[16px] font-bold text-neutral-primary leading-[100%] mb-[18px]">General
                                Information</h2>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-[14px]">
                                ...
                                <div class="col-span-1 sm:col-span-2">
                                    <BaseInputField label="Company Name" placeholder="Enter company name" />
                                </div>

                                <div class="col-span-1 sm:col-span-2 mt-[-2px] flex items-center justify-between">
                                    <label
                        ...
                        <!-- address -->
                        <div class="mb-[14px]">
                            <h2 class="text-[14px] sm:text-[16px] font-bold text-neutral-primary leading-[100%] mb-[18px]">Address</h2>

                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-[14px]">
                                <div class="col-span-1 sm:col-span-2">
                                    <BaseInputField label="Street Address" placeholder="Enter street address" />
                                </div>

                                <div class="col-span-1">
                                    <BaseInputField label="City" placeholder="Enter city" />
                                </div>

                                <div class="col-span-1">
                                    <BaseInputField label="State" placeholder="Enter state" />
                                </div>

                                <div class="col-span-1">
                                    <BaseInputField label="Zip Code" placeholder="Enter zip code" />
                                </div>
                            </div>
                        </div>
