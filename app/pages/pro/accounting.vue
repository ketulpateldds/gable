...
const payments: Payment[] = [
    {
        ...
        dueDate: "Jan 31, 2026",
        category: "Repairs • Oak St Apartments",
        invoice: "Invoice #INV-2031 • Maintenance",
        contact: "Jamie Chen",
    ...
    },
    {
        ...
        dueDate: "Jan 20, 2026",
        category: "Utilities • Pine View",
        invoice: "Invoice #INV-2019 • Gas",
        contact: "Alex Rivera",
    ...
    },
    {
        ...
        dueDate: "Feb 02, 2026",
        category: "Vendor payment • Market St Condo",
        invoice: "Transfer • Contractor payout",
    ...
    },
    {
        ...
        dueDate: "Jan 05, 2026",
        category: "Rent • Oak St Apartments",
        invoice: "Payment #PAY-9912 • Unit 5",
        contact: "Morgan Lee",
        email: "morgan@domain.com",
        total: "$3,400",
        balance: "$0",
    }
];
        ...
        <div class="flex-1 lg:ml-64 flex flex-col min-h-screen min-w-0 transition-all duration-300">
            ...
            <main class="flex-1 px-4 sm:px-6 pt-[19px] pb-10 flex flex-col">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                    <div class="border border-neutral-primary/10 rounded-[12px] px-[17px] pt-[14px] pb-[15px]">
                        <p
                            class="text-[10px] font-extrabold text-neutral-primary/60 uppercase leading-[100%] tracking-[10%] mb-[9px]">
                            Total outstanding
                        </p>
                        <h1 class="text-[20px] font-extrabold text-neutral-primary uppercase leading-[100%] mb-[6px]">
                            $12,480</h1>
                        <p class="text-[10px] font-bold text-neutral-primary/60 leading-[100%]">
                    ...
                    <div class="border border-neutral-primary/10 rounded-[12px] px-[17px] pt-[14px] pb-[15px]">
                        ...
                        <h1 class="text-[20px] font-extrabold text-neutral-primary uppercase leading-[100%] mb-[6px]">
                            $3,250</h1>
                        <p class="text-[10px] font-bold text-neutral-primary/60 leading-[100%]">
                            Upcoming scheduled payments and transfers.</p>
                    </div>
                    ...
                    <div class="border border-neutral-primary/10 rounded-[12px] px-[17px] pt-[14px] pb-[15px]">
                        ...
                        <h1 class="text-[20px] font-extrabold text-neutral-primary uppercase leading-[100%] mb-[6px]">
                            $18,940</h1>
                        <p class="text-[10px] font-bold text-neutral-primary/60 leading-[100%]">
                            Completed transactions recorded this month.</p>
                    </div>
                </div>
                ...
                <div class="border border-neutral-primary/10 rounded-[24px]">
                    <div class="flex flex-col md:flex-row md:items-center justify-between p-4 sm:p-6 gap-4">
                        ...
                        <div
                            ...
                            <div
                                class="relative flex items-center rounded-[80px] border border-neutral-primary/10 overflow-hidden whitespace-nowrap shrink-0">
                                <input type="date"
                                    class="w-full pl-5 pr-[30px] py-[13px] text-[12px] font-bold text-neutral-primary uppercase leading-[100%] tracking-[-0.02em] focus:outline-none bg-transparent appearance-none cursor-pointer" />
                                <span class="absolute right-[17px] pointer-events-none flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" class="text-neutral-primary" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            <button
                                class="pl-5 pr-[15px] py-[11px] rounded-[80px] border border-neutral-primary/10 text-[12px] font-bold text-neutral-primary uppercase leading-[100%] tracking-[-2%] flex items-center gap-[14px] whitespace-nowrap shrink-0 hover:bg-slate-50 transition-colors">
                        ...
                        <table class="w-full min-w-[900px]">
                            ...
                            <tbody>
                                <tr v-for="(payment, i) in payments" :key="i"
                                    ...
                                    <td
                                        class="pl-6 pr-1 py-[19px] text-[12px] font-bold leading-[100%] tracking-[-2%] whitespace-nowrap">
                                        <div class="inline-flex items-center gap-[7px] px-3 py-[6px] rounded-full border transition-colors"
                                            :class="[payment.bg, payment.border, payment.text]">
                                            {{ payment.status }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-1 py-[16px]">
                                        <div
                                            class="text-[12px] font-bold text-neutral-primary leading-[100%] tracking-[-2%] mb-[2px]">
                                            {{ payment.category }}</div>
                                        <div
                                            class="text-[12px] font-bold text-neutral-primary/60 leading-[100%] tracking-[-2%]">
                                            {{ payment.invoice }}</div>
                                    </td>
                                    ...
                                    <td class="py-[16px] pr-6 w-px text-right">
                                        <div
                                            class="text-[12px] font-bold text-neutral-primary leading-[100%] tracking-[-2%] mb-[2px]">
                                            {{ payment.total }}</div>
                                        <div
                                            class="text-[12px] font-bold text-neutral-primary/60 leading-[100%] tracking-[-2%]">
                                            Balance: {{ payment.balance }}</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
